...
async def get_user_access_details():
    try:
        ...
        user_access_details = [{ "id" : item['id'], "Chat" : appCheck("Chat",item), "Document" : appCheck("Document",item), "Image" : appCheck("Image",item), "Audio" : appCheck("Audio",item), "Legal" : appCheck("Legal",item)} for item in items]
        print(items)
